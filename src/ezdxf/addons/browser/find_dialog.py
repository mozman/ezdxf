...
class Ui_FindDialog(object):
    def setupUi(self, FindDialog):
        ...
        self.blocks_section = QtWidgets.QCheckBox(self.groupBox_2)
        self.blocks_section.setChecked(True)
        self.blocks_section.setObjectName("blocks_section")
        self.verticalLayout_4.addWidget(self.blocks_section)
    ...
    def retranslateUi(self, FindDialog):
        ...
        self.blocks_section.setText(_translate("FindDialog", "BLOCKS"))
