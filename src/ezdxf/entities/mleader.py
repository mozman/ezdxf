...
acdb_mleader_style = DefSubclass('AcDbMLeaderStyle', {
    ...
    'mtext_attachment_direction': DXFAttr(271, default=0),

    # 9 = Center; 10 = Underline and Center:
    'bottom_text_attachment_direction': DXFAttr(272, default=9),

    # 9 = Center; 10 = Overline and Center:
    'top_text_attachment_direction': DXFAttr(272, default=9),
