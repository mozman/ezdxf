## Version 1.1.3b1 - beta
	...
	- CHANGE: PR [#966](https://github.com/mozman/ezdxf/pull/966) `ezdxf.entities.dxfgfx.get_font_name()` to correctly handle implicitly-styled `TEXT` entities, contributed  by [neiljackson1984](https://github.com/neiljackson1984)
	- BUGFIX: PR [#965](https://github.com/mozman/ezdxf/pull/965) fixed typo in `ezdxf.path.rect()`, contributed  by [neiljackson1984](https://github.com/neiljackson1984)
	-
