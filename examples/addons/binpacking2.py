...
def build_packer():
    ...
    packer.add_bin("small-envelope", 12, 6, 1, 2000)
    packer.add_bin("large-envelope", 15, 12, 1, 2000)
    packer.add_bin("small-box", 8, 6, 1, 2000)
    packer.add_bin("medium-box", 11, 9, 5, 2000)
    packer.add_bin("medium-2-box", 14, 12, 4, 2000)
    packer.add_bin("large-box", 12, 12, 5, 2000)
    packer.add_bin("large-2-box", 24, 12, 3, 2000)
