...
def create_doc(filename):
    ...
    def add_grid(pos, width, height):
        ...
        msp.add_text('BASELINE ADJUSTMENTS (gjpqy)', dxfattribs=attribs).set_pos(
            (x, y - 1.5))
    ...
    msp = doc.modelspace()
    add_justify_text("ALIGNED-TEXT-ALIGNED-TEXT-gjpqy-ALIGNED-TEXT-ALIGNED-TEXT",
                     (15, 0), (35, 5), 'ALIGNED')
    add_justify_text("FITTED-TEXT-FITTED-TEXT-gjpqy-FITTED-TEXT-FITTED-TEXT",
                     (15, 10), (35, 5), 'FIT')
