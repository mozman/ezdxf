...
import ezdxf
from ezdxf.math import rational_splines_from_arc
...
for s in rational_splines_from_arc(arc.dxf.center, arc.dxf.radius, arc.dxf.start_angle, arc.dxf.end_angle):
