def get_dxf_doc_from_upload_data(dxf_uploaded_base64_data):
    """
    This function turns the dxf data provided by Dash Plotly upload component into an EZDXF doc
    Dash plotly upload compoment only provides base 64 encoded data.
    This returns an ezdxf doc object
    """
    if dxf_uploaded_base64_data is not None:
        # turn contents list into string. Contents is 64 encoded as per dash plotly
        contents = str(dxf_uploaded_base64_data)
