...
# License: MIT License
import pytest
from ezdxf.math import intersection_line_line, Vec2
...
def test_intersect_virtual():
    ...
    point = intersection_line_line(ray1, ray2)
...
def test_intersect_real():
    ...
    point = intersection_line_line(line1, line2, virtual=False)
