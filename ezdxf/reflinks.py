...
reference_guids = {
    ...
    'OBJECTS': {
        ...
        "RENDER": "GUID-6FC0020B-5FF4-4D98-B3CA-A901D5DA93B3",
        "SECTION": "GUID-78AB79F9-5155-4F05-8542-C6D16608E018",
...
def get_reference_link(name, section="ENTITIES"):
    default_guid = reference_guids['SECTIONS'].get(section, main_index_guid)
    guid = reference_guids[section].get(name, default_guid)
