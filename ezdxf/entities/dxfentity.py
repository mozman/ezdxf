...
#
from typing import TYPE_CHECKING, List, Any, cast, Union, Iterable, Set, Tuple
from collections import OrderedDict
from ezdxf.lldxf.types import DXFTag, handle_code, dxftag, uniform_appid
from ezdxf.lldxf.tags import Tags
from ezdxf.lldxf.extendedtags import ExtendedTags
from ezdxf.lldxf.attributes import DXFAttr, DXFAttributes, DefSubclass
from ezdxf.lldxf.const import DXF12, DXF2000, DXFKeyError, XDATA_MARKER
from ezdxf.lldxf.const import DXFAttributeError, DXFTypeError, DXFVersionError, DXFStructureError, DXFValueError
...
class XData:
    ...
    def add(self, appid: str, tags: Iterable) -> None:
        data = [dxftag(code, value) for code, value in tags]
