...
.. autofunction:: render_splines_and_polylines(layout: Layout, paths: Iterable[Path], *, segments: int = 3, dxfattribs: Dict = None) -> EntityQuery
...
.. autofunction:: to_splines_and_polylines(paths: Iterable[Path], *, segments: int = 3, dxfattribs: Dict = None) -> Iterable[Union[Spline, Polyline]]
...
.. autofunction:: to_bsplines_and_vertices(path: Path, segments: int = 3) -> Iterable[Union[BSpline, List[Vec3]]]
