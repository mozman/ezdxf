...
To ensure the same spline geometry for all CAD application, the spline has to be defined by control points. The method
...
- black: AutoCAD/BricsCAD spline generated from fit points
- red: ezdxf spline curve interpolation, ``'uniform'`` method
- green: ezdxf spline curve interpolation, ``'distance'`` method
- blue: ezdxf spline curve interpolation, ``'centripetal'`` method
