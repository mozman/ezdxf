...
`ezdxf` requires at least Python 3.6 and will be tested with the latest stable
CPython 3 version and the latest stable release of pypy3 during development.
