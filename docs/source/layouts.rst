...
.. method:: Layout.add_attrib(tag, text, insert, attribs={})

   Add an :class:`Attrib` element, `tag` is the attrib-tag, `text` is the
   attrib content.

.. method:: Layout.add_polyline2D(points, attribs={})

   Add a :class:`Polyline` element, `points` is list of 2D points.

.. method:: Layout.add_polyline3D(points, attribs={})

   Add a :class:`Polyline` element, `points` is list of 3D points.

.. method:: Layout.add_polymesh(size=(3, 3), attribs={})
...
.. method:: Layout.add_polyface(attribs={})
...
.. method:: BlockLayout.add_attdef(tag, insert, attribs={})
